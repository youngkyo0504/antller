...
sm:grid-cols-2
mt-10 grid-cols-1  grid-flow-row-dense auto-cols-max max-w-[100rem] px-mo-content mx-auto gap-y-[2.2rem] lg:gap-y-[3.125rem] gap-x-[1.25rem] w-full overflow-hidden`;
